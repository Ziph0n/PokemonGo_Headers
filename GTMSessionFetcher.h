...
@property (retain) NSData * downloadedData;                                      //@synthesize downloadedData=_downloadedData - In the implementation block
...
@property (assign) BOOL useBackgroundSession;                                    //@synthesize useBackgroundSession=_useBackgroundSession - In the implementation block
...
-(void)shouldRetryNowForStatus:(long long)arg1 error:(id)arg2 response:(/*^block*/id)arg3 ;
